...
<div class="col-md-3">
  <div id="ccardprintcontact" class="smround">
    <p><a href="?p=collections/controlcard&amp;id=<?php echo $objCollection->ID; ?>&amp;templateset=print&amp;disabletheme=1"><img
        src="<?php echo $_ARCHON->PublicInterface->ImagePath; ?>/printer.png" alt="<?php echo $printerFriendly; ?>" /></a> <a
        href="?p=collections/controlcard&amp;id=<?php echo $objCollection->ID; ?>&amp;templateset=print&amp;disabletheme=1"><?php echo $printerFriendly; ?></a></p>
    <p><a href="?p=collections/research&amp;f=email&amp;repositoryid=$repositoryid&amp;referer="<?php echo urlencode($_SERVER["HTTP_HOST"] . $_SERVER["REQUEST_URI"]); ?>"><img
        src="<?php echo $_ARCHON->PublicInterface->ImagePath; ?>/email.png" alt="<?php echo $emailUs; ?>" /> </a><a
        href="?p=collections/research&amp;f=email&amp;repositoryid=$repositoryid&amp;referer="<?php echo urlencode($_SERVER["HTTP_HOST"] . $_SERVER["REQUEST_URI"]); ?>"><?php echo $emailUs; ?></a></p>
    <p><?php
      if(defined('PACKAGE_COLLECTIONS')) {
        ...
        echo("<span id='viewcartlink' class='$class' $hidden><a href='?p=collections/research&amp;f=cart&amp;referer=" . urlencode($_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']) . "'>".$_ARCHON->getPhrase('view_cart', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML)."</a></span>");
      } ?>
    </p>
    <?php
    ...
    {
    ?>
    <div class='ccardcontent'><span class='ccardlabel'><?php echo $_ARCHON->getPhrase('container_list', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?></span><br/>
      <?php
...
<div class="col-md-6">
  ...
  if(!empty($objCollection->Creators))
  {
    ...
    <div class='ccardcontent'><span class='ccardlabel'><a href='#' onclick="toggleDisplay('CollectionCreators'); return false;"><img id='CollectionCreatorsImage' src='<?php echo($_ARCHON->PublicInterface->ImagePath); ?>/plus.gif' alt='expand icon' />
          <?php echo $_ARCHON->getPhrase('creators', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?>
        </a></span>
  ...
  {
    ?>
    <div class='ccardcontent'><span class='ccardlabel'><?php echo $_ARCHON->getPhrase('collection_id', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?></span> <?php echo($objCollection->Classification->toString(LINK_NONE, true, false, true, false)); ?> <?php echo($objCollection->getString('CollectionIdentifier')); ?></div>
  <?php
  }
  if ($objCollection->ArkID) {
    ?>
    <div class='ccardcontent'><span class='ccardlabel'><?php echo $_ARCHON->getPhrase('ark_id', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?></span> <?php echo($objCollection->ArkID); ?></div>
    <?php
  }
  /**
   * Extents
  ...
  {
    ?>
    <div class='ccardcontent'><span class='ccardlabel'><?php echo $_ARCHON->getPhrase('extent', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?></span> <?php echo(preg_replace('/\.(\d)0/', ".$1", $objCollection->getString('Extent'))) . " "; ?><?php echo( is_null($objCollection->ExtentUnit)? '' : $objCollection->ExtentUnit->toString()); ?>
    </div>
    <?php
  }
  if($objCollection->AltExtentStatement)
  {
    ...
    <div class='ccardcontent'><span class='ccardlabel'><a href='#' onclick="toggleDisplay('CollectionAltExtent'); return false;"><img id='CollectionAltExtentImage' src='<?php echo($_ARCHON->PublicInterface->ImagePath); ?>/plus.gif' alt='expand icon' />
          <?php echo $_ARCHON->getPhrase('coll_alt_extents', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?>
        </a></span>
  ...
  {
    ?>
    <div class='ccardcontent'><span class='ccardlabel'><a href='#' onclick="toggleDisplay('scopeAndContents'); return false;"><img id='scopeAndContentsImage' src='<?php echo($_ARCHON->PublicInterface->ImagePath); ?>/plus.gif' alt='expand icon' /> <?php echo $_ARCHON->getPhrase('scope_and_contents', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?></a></span><br/>
  ...
  if($objCollection->BiogHist)
  {
    ...
    <div class='ccardcontent'><span class='ccardlabel'><a href='#' onclick="toggleDisplay('CollectionBiogHist'); return false;"><img id='CollectionBiogHistImage' src='<?php echo($_ARCHON->PublicInterface->ImagePath); ?>/plus.gif' alt='expand icon' />
          <?php echo $_ARCHON->getPhrase('bio_historical_notes', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?>
        </a></span>
  ...
  if(!empty($objCollection->OtherURL))
  {
    ...
    ?>
    <div class='ccardcontent'><span class='ccardlabel'><?php echo $_ARCHON->getPhrase('other_find_aid', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?></span> <a
        href='<?php echo($objCollection->getString('OtherURL')); ?>' <?php echo($onclick); ?>><?php echo($objCollection->getString('OtherURL')); ?></a></div>
  <?php
  }
  ...
  {
    ?>
    <div class='ccardcontent'><span class='ccardlabel'><?php echo $_ARCHON->getPhrase('statement_on_access', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?></span> <?php echo($objCollection->getString('AccessRestrictions')); ?></div>
  <?php
  }
   ...
   */
?>
  <h2><?php echo $_ARCHON->getPhrase('more_information', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?></h2>
  <div class="ccardshowlist">
<?php
  if($objCollection->Arrangement)
  {
  ?>
  <div class='ccardcontent'><span class='ccardlabel'><a href='#' onclick="toggleDisplay('CollectionArrangement'); return false;"><img
          id='CollectionArrangementImage' src='<?php echo($_ARCHON->PublicInterface->ImagePath); ?>/plus.gif' alt='expand icon' />
        <?php echo $_ARCHON->getPhrase('arrangement', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?>
      </a></span>
  ...
  {
    ?>
    <div class='ccardcontent'><span class='ccardlabel'><?php echo $_ARCHON->getPhrase('preferred_citation', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?></span> <?php
  ...
  {
    ?>
    <div class='ccardcontent'><span class='ccardlabel'><?php echo $_ARCHON->getPhrase('acquisition_note', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?> </span>
      <?php
  ...
  {
    ?>
    <div class='ccardcontent'><span class='ccardlabel'><?php echo $_ARCHON->getPhrase('acquired', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?></span>
      <?php
  ...
  {
    ?>
    <div class='ccardcontent'><span class='ccardlabel'><?php echo $_ARCHON->getPhrase('processing_note', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?></span> <?php
  ...
  {
    ?>
    <div class='ccardcontent'><span class='ccardlabel'><?php echo $_ARCHON->getPhrase('languages_of_materials', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?></a></span><br/>
...
?>
  ...
  ?>
  <hr />
  <div class='ccardcontent'><span class='ccardlabel'><a href='#' onclick="toggleDisplay('otherinformation'); return false;"><img id='otherinformationImage' src='<?php echo($_ARCHON->PublicInterface->ImagePath); ?>/plus.gif' alt='expand icon' /> <?php echo $_ARCHON->getPhrase('other_information', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?></a></span><br/>
  <div class='ccardshowlist' style='display:none' id='otherinformationResults'>
<?php
    if($objCollection->PredominantDates)
    {
    ?>
    <div class='ccardcontent'><span class='ccardlabel'><?php echo $_ARCHON->getPhrase('predominant_dates', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?></span> <?php echo($objCollection->PredominantDates); ?></div>
    <?php
    }
  ...
  {
    ?>
    <div class='ccardcontent'><span class='ccardlabel'><?php echo $_ARCHON->getPhrase('repository', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?></span> <?php echo$objCollection->Repository->getString('Name'); ?></div>
  <?php
  }
  ...
  {
    ?>
    <div class='ccardcontent'><span class='ccardlabel'><?php echo $_ARCHON->getPhrase('rights', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?></span> <?php echo($objCollection->getString('UseRestrictions')); ?></div>
  <?php
  }
  ...
  {
    ?>
    <div class='ccardcontent'><span class='ccardlabel'><?php echo $_ARCHON->getPhrase('access_notes', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?> </span><?php echo($objCollection->getString('PhysicalAccess')); ?></div>
  <?php
  }
  ...
  {
    ?>
    <div class='ccardcontent'><span class='ccardlabel'><?php echo $_ARCHON->getPhrase('technical_notes', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?> </span><?php echo($objCollection->getString('TechnicalAccess')); ?></div>
  ...
  {
    ?>
    <div class='ccardcontent'><span class='ccardlabel'><?php echo $_ARCHON->getPhrase('appraisal_notes', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?></span> <?php echo($objCollection->getString('AppraisalInformation')); ?></div>
  <?php
  }
  ...
  {
    ?>
    <div class='ccardcontent'><span class='ccardlabel'><?php echo $_ARCHON->getPhrase('other_formats', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?></span>
      <?php
  ...
  {
    ?>
    <div class='ccardcontent'><span class='ccardlabel'><?php echo $_ARCHON->getPhrase('related_publications', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?></span> <?php echo($objCollection->getString('RelatedPublications')); ?></div>
  <?php
  }
  ...
  {
    ?>
    <div class='ccardcontent'><span class='ccardlabel'><?php echo $_ARCHON->getPhrase('finding_aid_revisions', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?></span> <?php echo($objCollection->getString('RevisionHistory')); ?></div>
  <?php
  }
  ...
  {
    ?>
    <div class='ccardcontent'><span class='ccardlabel'><?php echo $_ARCHON->getPhrase('collection_material_type', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?></span> <?php echo($objCollection->MaterialType->toString()); ?></div>
  <?php
  }
  ...
  {
    ?>
    <div class='ccardcontent'><span class='ccardlabel'><?php echo $_ARCHON->getPhrase('other_note', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?> </span><?php echo($objCollection->getString('OtherNote')); ?></div>
  <?php
  }
?>
    </div>
  ...
  {
  ?>
  <div class='ccardcontent'><span class='ccardlabel'><a href='#' onclick="toggleDisplay('accessions'); return false;"><img id='accessionsImage' src='<?php echo($_ARCHON->PublicInterface->ImagePath); ?>/plus.gif' alt='expand icon' /> <?php echo $_ARCHON->getPhrase('unprocessed_materials', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?><?php
        if($_ARCHON->Security->verifyPermissions(MODULE_COLLECTIONS, READ))
        {
          echo $_ARCHON->getPhrase('processed_accessions', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML);
        }
        ?></a></span><br/>
  ...
  {
    ?>
    <div class='ccardcontent'><span class='bold'><a href='#' onclick="toggleDisplay('LinkedBooks'); return false;"><img id='LinkedBooksImage' src='<?php echo($_ARCHON->PublicInterface->ImagePath); ?>/plus.gif' alt='expand icon' /> <?php echo $_ARCHON->getPhrase('books', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?> </a></span><br/>
  ...
  {
    ?>
    <div class='ccardcontent'><span class='ccardlabel'><a href='#' onclick="toggleDisplay('docsandfiles'); return false;"><img id='docsandfilesImage' src='<?php echo($_ARCHON->PublicInterface->ImagePath); ?>/plus.gif' alt='expand icon' /> <?php echo $_ARCHON->getPhrase('online_docs_files', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?></a></span><br/>
  ...
  if($_ARCHON->Security->verifyPermissions(MODULE_COLLECTIONS, READ))
  {
    ...
    <div id='ccardstaff' class='mdround'>
      <h2><?php echo $_ARCHON->getPhrase('staff_info', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?></h2>
      <div class='ccardcontents'>
        <span class='ccardlabel'><?php echo $_ARCHON->getPhrase('storage_locations', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?></span>
        <?php
...
<div class="col-md-3">
  ...
  if (!empty($objCollection->Subjects)) {
    ...
    if (!empty($arrSubjects)) {
      ...
      <div class='ccardcontent'><span class='ccardlabel'><a href='#' onclick="toggleDisplay('subjects'); return false;"><img
              id='subjectsImage' src='<?php echo($_ARCHON->PublicInterface->ImagePath); ?>/plus.gif' alt='expand icon'/> <?php echo $_ARCHON->getPhrase('subjects', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?></a></span><br/>
    ...
    if (!empty($arrGenres)) {
      ...
      <div class='ccardcontent'><span class='ccardlabel'><a href='#' onclick="toggleDisplay('genres'); return false;"><img
              id='genresImage' src='<?php echo($_ARCHON->PublicInterface->ImagePath); ?>/plus.gif' alt='expand icon'/> <?php echo $_ARCHON->getPhrase('forms_of_material', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?></a></span><br/>
  ...
  if($objCollection->RelatedMaterials || $objCollection->RelatedMaterialsURL)
  {
    ...
    <div class='ccardcontent'><span class='ccardlabel'><a href='#' onclick="toggleDisplay('relatedMats'); return false;"><img
            id='relatedMatsImage' src='<?php echo($_ARCHON->PublicInterface->ImagePath); ?>/plus.gif' alt='expand icon'/> <?php echo $_ARCHON->getPhrase('related_materials', PACKAGE_COLLECTIONS, 0, PHRASETYPE_PUBLIC)->getPhraseValue(ENCODE_HTML); ?></a></span><br />
